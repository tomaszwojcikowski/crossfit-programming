...
## Warmup (10 min)
- **R1 RAISE (2:00 easy):** Easy jog, bike, or row
  - 20 x Single unders
  - 8 x Air squats
- **R2 ACTIVATE (1:30 moderate):** Build rope and run rhythm
  - 30 x Single unders
  - 10 x Double unders or 20 x single unders
  - 60 m easy run
- **R3 POTENTIATE (1:00 hard):** 2 x 15s fast rope cadence
  - 15 x Double unders or 30 x single unders
  - 100 m brisk run
- Rest 30s between rounds

## Post-Warmup Mobility (75s)
- Calf stretch on wall: 30-45s/side
- Wrist extension rocks: 30s

## Skill: Double-Under Ladder (8 min)
**Every set unbroken:**

10-15-20-25-30-25-20-15-10 Double Unders

Miss a set? Restart that set or drop to single unders at 2:1 for that round only.
...
2. Calf stretch: 45s/side
3. Child's pose with reach: 45s/side
